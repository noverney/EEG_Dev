...
def plot_data(data, fs, filename="test"):
    """Plot the data
...
def clustering(data, fs, chs, locs, mode, n_clusters, doplot=False):
    ...
    # --- microstate sequence ---
    # we are modified the sequence of microstates by multiplying the data_norm
    # to the maps so we have a map to each timepoint?
