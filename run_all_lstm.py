...
for chunk_size in range(10,100,10):
    for hidden_dims in configs:
        ...
        for random_state in range(10):
            print(f"LSTMModelMultiLayer_{hidden_dims_name}_{chunk_size}_{random_state}")
            run_lstm(filepath, chunk_size,epoches, hidden_dims,False,prefix,random_state)
            index +=1
